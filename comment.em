...
function InitGlobalVars ()
{
    ...
    global Language_BAT, Language_ASM, Language_GNU_ASM
    global Language_PHY, Language_Makefile

    Language_ASL = "ACPI Source Language (ASL)"
    Language_FDF = "EDK II FDF Language"
    Language_INF = "EDK II INF Language"
    Language_DSC = "EDK II DSC Language"
    Language_DEC = "EDK II DEC Language"
    Language_VFR = "EDK II VFR Language"
    Language_BAT = "Microsoft Batch Scripts"
    Language_ASM = "x86 Asm Language"
    Language_GNU_ASM = "X86 GNU Assembler Language"
    Language_PHY = "Python"
...
function GetCommentStringByLanguage (hbuf)
{
    ...
    if (Props.Language == Language_ASL ||
        ...
        RetString = Comment_DoubleSlash
               ...
               Props.Language == Language_GNU_ASM ||
               Props.Language == Language_PHY ||
               Props.Language == Language_Makefile
               ) {
...
macro CommentBlock()
{
  ...
  str = GetCommentStringByLanguage (hbuf)
  if (str != nil) {
    CommentStr = cat(str, " ");
  } else {
    CommentStr = "//  ";
